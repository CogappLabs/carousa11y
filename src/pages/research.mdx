...
description: In-depth accessibility research comparing 11 carousel libraries. Detailed WCAG analysis, screen reader testing results, and implementation recommendations.
---

# Accessible Carousel Library Comparison

> Scores re-fetched 2026-06-07 from [isitaccessible.dev](https://isitaccessible.dev/). Local WCAG 2.1 AA and W3C pattern audits run against this site's own implementations on the same date.
...
| react-responsive-carousel | 100% | 2.7k | Jan 2026 | No | Yes | Passes our audit |
| Siema | 85.7% | 3.5k | Sep 2024 | Yes | Wrap | Unmaintained |
| Swiper | 86.4% | 41.8k | Jan 2026 | Yes | Yes | Keyboard/SR issues |
...
| Library | A11y Score | Stars | Notes |
|---------|------------|-------|-------|
| Pure React Carousel | 80% | 1.7k | React-only. Reported wrong ARIA roles. Not tested on this site. |
